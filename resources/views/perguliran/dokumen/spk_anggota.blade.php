...
$waktu = date('H:i');
$tempat = 'Kantor UPK';
$wt_cair = explode('_', $pinkel->pinkel->wt_cair);
if (count($wt_cair) == 1) {
$waktu = $wt_cair[0];
}
if (count($wt_cair) == 2) {
    ...
    <div style="text-align: justify;">
        ...
        <ol style="text-align: justify;">
            ...
            <li>
                ...
                {{ $pinkel->pros_jasa / $pinkel->jangka }}% per-bulan dikalikan pokok
                pinjaman.
            </li>
            <li>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 12px;" class="p0">
        <tr>
            <td style="padding: 0px !important;">
                <table class="p0" border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 12px;">
                    <tr>
                        <td style="padding: 0px !important;">
                            <div style="text-align: center;">
                ...
                <table border="0" width="98%" cellspacing="0" cellpadding="0" style="font-size: 11px;" class="p">
                    <tr>
                        <td width="45%" align="center">
                            Pihak Pertama <br> <br> <br> <br>
                            <u> {{ $dir->namadepan }} {{ $dir->namabelakang }}</u><br>{{ $kec->sebutan_level_1 }} {{ $kec->nama_lembaga_sort }}
                        </td>
                        ...
                        <td width="45%" align="center">
                            ...
                            <table border="0" width="98%" cellspacing="0" cellpadding="0" style="font-size: 11px;">
                                <tr>
                                    <td width="50%" align="center">
                                        <u>{{ $pinkel->kelompok->ketua }}</u><br>
                                        Ketua Kelompok
                                    </td>
                                    <td width="50%" align="center">
                                        <u>{{ $pinkel->anggota->namadepan }}</u><br>
                                        Anggota Kelompok
                                    </td>
                                </tr>
                            </table>
