...
@section('modal')
<div class="modal fade" id="DetailAngsuran" tabindex="-1" aria-labelledby="DetailAngsuranLabel" aria-hidden="true">
...
<div class="modal fade" id="DetailIndividu" tabindex="-1" aria-labelledby="DetailIndividuLabel" aria-hidden="true">
...
<div class="modal fade" id="AngsuranAnggota" tabindex="-1" aria-labelledby="AngsuranAnggotaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
