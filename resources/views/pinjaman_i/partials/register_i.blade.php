<div class="card">
    <div class="card-header p-3 pt-2">
        ...
        <h6 class="mb-0">
            Register Proposal Individu {{ $individu->nama_depan }}
        </h6>
        <div class="text-xs">
            {{ $individu->d->sebutan_desa->sebutan_desa }} {{ $individu->d->nama_desa }},
            {{ $individu->d->kd_desa }}
        </div>
    </div>
    <div class="card-body pt-0">
        <form action="/perguliran" method="post" id="FormRegisterProposal">
            ...
            <input type="hidden" name="id_kel" id="id_kel" value="{{ $individu->id }}">
            <div class="row">
                <div class="col-md-3">
