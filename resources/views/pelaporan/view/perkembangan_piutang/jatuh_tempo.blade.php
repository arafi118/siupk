...
@section('content')
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 11px;">
        <tr style="background: rgb(230, 230, 230); font-weight: bold;">
            ...
            <th class="t l b" width="10%">Loan ID.</th>
            <th class="t l b" width="24%">Nasabah.</th>
            ...
            @if ($pinkel->target)
                ...
                @if ($nunggak_pokok > 0 || $nunggak_jasa > 0)
                    <tr>
                        ...
                        <td class="t l b">{{ $pinkel->id }}</td>
                        <td class="t l b">{{ $pinkel->anggota->namadepan}} </td>
                        <td class="t l b">
                            {{ $pinkel->anggota->alamat_anggota }} {{ $pinkel->anggota->d->nama_desa }}
                        </td>
