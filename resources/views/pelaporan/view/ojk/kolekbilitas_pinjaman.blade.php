...
@section('content')
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 11px; table-layout: fixed;">
            ...
            @if (count($kd_desa) > 0)
                ...
                <tr style="font-weight: bold;">
                    ...
                    <td class="t l b" colspan="2" align="center">(Lancar + Diragukan + Macet)</td>
                ...
                <tr>
                    ...
                    <td class="t l b r" align="center">{{ number_format(($t_kolek3 * 25) / 100) }}</td>
                </tr>
                <tr>
    ...
    @foreach ($jenis_pp as $jpp)
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0"
            ...
            @foreach ($jpp->pinjaman_individu as $pinj_Ang)
                @php
                ...
                @if (isset($counted_values[$pinj_Ang->kd_desa]) && $counted_values[$pinj_Ang->kd_desa] <= 1)
                    @if ($section != $desa && count($kd_desa) > 1)
                        @php
                            $j_pross = $j_saldo / $j_alokasi;
                            $t_alokasi += $j_alokasi;
                    ...
                    <tr style="font-weight: bold;">
                        <td class="t l b r" colspan="7" align="left">{{ $pinj_Ang->kode_desa }}.
                ...
                @php
                    ...
                    $tgl_cair = explode('-', $pinj_Ang->tgl_cair);
                    $th_cair = $tgl_cair[0];
                    $bl_cair = $tgl_cair[1];
                    $tg_cair = $tgl_cair[2];
            ...
            @if (count($kd_desa) > 0)
                ...
                <tr style="font-weight: bold;">
                    <td width="25%" class="t l b" colspan="2" align="center" height="20">J U M L A H</td>
