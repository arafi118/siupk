...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
    ...
    <tr>
        <td height="20" colspan="6" class="style6 bottom align-center"><br>DAFTAR RINCIAN TABUNGAN KELOMPOK <br><br>
        </td>
    </tr>
</table>
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
    <tr>
        <td width="20%" class="style9">NAMA UPK</td>
        <td width="70%" class="style9">:{{ $kec->nama_lembaga_long }}</td>
    </tr>
    <tr>
        <td width="20%" class="style9">SANDI UPK</td>
...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
    ...
    <tr>
        <td height="20" colspan="6" class="style6 bottom align-center"><br>DAFTAR RINCIAN TABUNGAN INDIVIDU <br><br>
        </td>
    </tr>
</table>
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
