            ...
            <tr>
                <td colspan="3" align="center">
                    <div style="font-size: 18px;">
                        <b>
                            CADANGAN PENYISIHAN PENGHAPUSAN KREDIT
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 11px; table-layout: fixed;">
            ...
            @if (count($kd_desa) > 0)
                ...
                @php
                    ...
                    $lancar = $t_kolek1 * $a ;
                    $diragukan = $t_kolek2 * $b ;
                    $macet = $t_kolek3 * $c ;

                    $total_persen = $lancar + $diragukan + $macet;
                    ...
                    <td colspan="3" style="padding: 0px !important;">
                        ...
                        <table width="96%" border="0" align="center" cellpadding="3" cellspacing="0" class="style9">
                            ...
                            <tr align="center" height="100%" style="background:rgba(0,0,0, 0.4);">
                                <td width="3%"  class="left bottom">a</td>
                            ...
                            <tr align="center">
                                ...
                                <th class="left right bottom top" align="right">{{ number_format($totals) }}</th>
                                <th class="left right bottom top" align="right">{{number_format($total_persen)}}</th>
                            </tr>
