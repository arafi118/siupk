    ...
    <table width="96%" border="0" align="center" cellpadding="3" cellspacing="0">
        ...
        @foreach ($jpp->pinjaman_kelompok as $pinj)
            ...
            @php
                ...
                if ($pinj->tgl_lunas <= $tgl_kondisi && ($pinj->status == 'L' || $pinj->status == 'H' || $pinj->status == 'R')) {
                    $kolek = 0;
                }
        ...
        <tr style="font-weight: bold; border: 1px solid;">
            ...
            <tr class="style9">
                <th colspan="7" class="left top" align="center"style="background:rgba(0,0,0, 0.3);">TOTAL KESELURUHAN({{$jumlah_aktif}} Anggota)</th>
